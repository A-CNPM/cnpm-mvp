...
class SearchingService:
    ...
    def search_session(self, criteria: SessionSearchCriteria) -> List[Session]:
        ...
        for s in fake_sessions_db.values():
            ...
            # 5. Lọc theo thời gian (Giả lập so sánh chuỗi đơn giản cho demo)
            # Trong thực tế cần convert sang datetime object
            if criteria.date_from and s.get("time") < criteria.date_from:
                continue
