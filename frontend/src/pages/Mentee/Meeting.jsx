...
// Lưu ý: Đảm bảo đường dẫn này trỏ đúng tới file service bạn vừa tạo
    ...
    try {
      ...
      const formattedData = data.map((item) => {
        ...
        return {
            ...
            topic: item.topic,
            tutor: item.tutorID, // Backend trả về ID
    ...
    <>
      <div className="mentee-dashboard">
        ...
        <main className="main-content">
          ...
          {/* --- KHU VỰC BỘ LỌC (Hiện ra khi bấm nút Filters) --- */}
          {showFilters && (
            <div style={{
                marginBottom: 20, 
                marginTop: -10,
       ...
       {showDetail && detailData && (
        <div className="modal-overlay">
          <div 
            ...
            style={{
                maxWidth: "650px",      // Giới hạn chiều rộng
                width: "90%",           // Responsive trên mobile
                maxHeight: "90vh",      // Không bao giờ cao quá 90% màn hình
                overflowY: "auto",      // Hiện thanh cuộn nếu nội dung dài
                padding: "20px 25px",   // Giảm padding cho gọn
          ...
          >
            <h3 style={{
                ...
                paddingBottom: 10,
                fontSize: "18px"        // Giảm cỡ chữ tiêu đề chút
            }}>
            ...
            <div style={{marginTop: 15}}>
              ...
              <textarea 
                ...
                readOnly 
                rows={3} // Giảm số dòng xuống 3 cho gọn
            ...
            <div style={{textAlign: "right", marginTop: 20}}>
                <button 
                    ...
                    style={{padding: "8px 20px", fontSize: "14px"}} // Nút nhỏ lại xíu
                >
                    Đóng
                </button>
            </div>
